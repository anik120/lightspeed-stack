"""Llama Stack implementation for query endpoint."""
...
from utils.endpoints import validate_and_retrieve_conversation
...
async def query_endpoint_handler_llama_stack(
    request: Request,
    query_request: QueryRequest,
    auth: AuthTuple,
    mcp_headers: McpHeaders,
) -> QueryResponse:
    """Handle query request using Llama Stack Responses API.

    Processes the query through Llama Stack's OpenAI-compatible responses.create() API.
